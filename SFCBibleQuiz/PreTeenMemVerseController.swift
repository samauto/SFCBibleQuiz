//
//  PreTeenMemVerseController.swift
//  SFCBibleQuiz
//
...
class PreTeenMemVerseController: UIViewController {
    ...
    func gameStart() {
        ...
        Questions = memVerse.memVersePreTeen2016
    ...
    func gameOver() {
        ...
        { action -> Void in
            self.performSegue(withIdentifier: "PreTeenMenu", sender: self)
        })
...
//END OF CLASS: PreTeenMemVerseController
