...
class KGMemVerseController: UIViewController {
    ...
    func gameStart() {
        ...
        Questions = memVerse.memVerseKG2016
    ...
    func gameOver() {
        ...
        alertController.addAction(UIAlertAction(title: "Back to Menu", style: UIAlertActionStyle.default)
            { action -> Void in
            self.performSegue(withIdentifier: "KGMenu", sender: self)
            })
...
//END OF CLASS: KGMemVerseController
