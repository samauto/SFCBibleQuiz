//
//  YoungTeenMemVerseController.swift
//  SFCBibleQuiz
//
...
class YoungTeenMemVerseController: UIViewController {
    ...
    func gameStart() {
        ...
        Questions = memVerse.memVerseYoungTeen2016
    ...
    func gameOver() {
        ...
        { action -> Void in
            self.performSegue(withIdentifier: "YoungTeenMenu", sender: self)
        })
...
//END OF CLASS: YoungTeenMemVerseController
