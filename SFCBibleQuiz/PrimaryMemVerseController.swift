//
//  PrimaryMemVerseController.swift
//  SFCBibleQuiz
//
...
class PrimaryMemVerseController: UIViewController {
    ...
    func gameStart() {
        ...
        Questions = memVerse.memVersePrimary2016
...
//END OF CLASS: PrimaryMemVerseController
