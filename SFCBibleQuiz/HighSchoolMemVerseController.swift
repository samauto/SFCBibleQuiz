//
//  HighSchoolMemVerseController.swift
//  SFCBibleQuiz
//
...
class HighSchoolMemVerseController: UIViewController {
    ...
    func gameStart() {
        ...
        Questions = memVerse.memVerseHighSchool2016
    ...
    func gameOver() {
        ...
        { action -> Void in
            self.performSegue(withIdentifier: "HighSchoolMenu", sender: self)
        })
...
//END OF CLASS: HighSchoolMemVerseController
